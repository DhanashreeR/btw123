...
/********** Added by Dhanashree *******/
     ...
     {
        $data = $this->db->query("Select visa_status From country_mapping Where destination_country_id = ".$country_id);
        if($data->num_rows() > 0){
           //return $data->result_array();
    ...
    public function get_valid_visa($country_id)
    {
          // echo "Hello"; 
           echo $country_id;
          // echo ("Select valid_visa_country From country_mapping Where destination_country_id = ".$country_id);
        $data = $this->db->query("Select valid_visa_country From country_mapping Where destination_country_id = ".$country_id);
           ...
           $getdata2 = $getdata[0]['valid_visa_country'];
            
                    
         //echo ("Select country From country_master Where country_id IN (".$getdata2.")"); 
        $data2 = $this->db->query("Select country From country_master Where country_id IN (".$getdata2.")");    
         ...
         if($data2->num_rows() > 0)
         {
             ...
             $status = $data2->result_array();
            


        }  
             $status = $status[0]['country'];
              //$status = $data2->first_row()->visa_status;  
